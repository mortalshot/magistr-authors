(() => {
    ...
    document.addEventListener("click", (function(e) {
        ...
        if (!targetElement.closest(".menu-item_has-children") && document.querySelectorAll(".menu-item_has-children._active").length > 0) removeClasses(document.querySelectorAll(".menu-item_has-children._active"), "_active");
        if (targetElement.classList.contains("sub-menu__back") || targetElement.closest(".sub-menu__back")) removeClasses(document.querySelectorAll(".menu-item_has-children._active"), "_active");
        if (targetElement.classList.contains("range-datepicker") || targetElement.closest(".range-datepicker")) targetElement.closest(".range-datepicker").classList.add("_active");
        if (!targetElement.closest(".range-datepicker") && document.querySelectorAll(".range-datepicker._active").length > 0) removeClasses(document.querySelectorAll(".range-datepicker"), "_active");
        if (targetElement.classList.contains("calendar-item__toggler") || targetElement.closest(".calendar-item__toggler")) targetElement.closest(".calendar-item__item_has-children").classList.toggle("_active");
        if (!targetElement.closest(".calendar-item__toggler") && document.querySelectorAll(".calendar-item__item_has-children._active").length > 0) removeClasses(document.querySelectorAll(".calendar-item__item_has-children"), "_active");
        if (targetElement.classList.contains("notification-widget__close") || targetElement.closest(".notification-widget__close")) targetElement.closest(".notification-widget").classList.remove("_active");
    }));
    const template4NavigationLinks = document.querySelectorAll(".template4__link");
    if (template4NavigationLinks.length > 0) if (window.innerWidth >= 767.98) template4NavigationLinks.forEach((link => {
    ...
    if (datepickerInputs.length > 0) datepickerInputs.forEach((datepickerInput => {
